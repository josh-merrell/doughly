...
module.exports = ({ db }) => {
  const sequenceShifter = async (userID, authorization, recipeStepID, newSeq) => {
    try {
      ...
      throw errorGen(err.message || '*recipeSteps-sequenceShifter* Unhandled Error', err.code || 520, err.name || 'unhandledError_recipeSteps-sequenceShifter', err.isOperational || false, err.severity || 2);
    }
  };
  ...
  async function getAll(options) {
    ...
    try {
      ...
      if (error) {
        throw errorGen(`*recipeSteps-getAll* Error getting recipeSteps: ${error.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      ...
      throw errorGen(err.message || '*recipeSteps-getAll* Unhandled Error', err.code || 520, err.name || 'unhandledError_recipeSteps-getAll', err.isOperational || false, err.severity || 2);
    }
  }
  ...
  async function getStepByID(options) {
    try {
      ...
      if (error) {
        throw errorGen(`*recipeSteps-getStepByID* Error getting recipeStep by ID: ${options.recipeStepID}:${error.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      ...
      throw errorGen(err.message || '*recipeSteps-getStepByID* Unhandled Error', err.code || 520, err.name || 'unhandledError_recipeSteps-getStepByID', err.isOperational || false, err.severity || 2);
    }
  }
  ...
  async function create(options) {
    ...
    try {
      ...
      if (validationError) {
        throw errorGen(`*recipeSteps-create* Error validating recipe ID: ${recipeID} while creating recipeStep ${validationError.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      if (!recipe.length) {
        throw errorGen(`*recipeSteps-create* Provided recipe ID: ${recipeID} does not exist, cannot create recipeStep`, 515, 'cannotComplete', false, 3);
      }

      //validate that provided stepID exists
      const { data: step, error: stepError } = await db.from('steps').select().eq('stepID', stepID);
      if (stepError) {
        throw errorGen(`*recipeSteps-create* Error validating step ID: ${stepID} while creating recipeStep ${stepError.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      if (!step.length) {
        throw errorGen(`*recipeSteps-create* Provided step ID: ${stepID} does not exist, cannot create recipeStep`, 515, 'cannotComplete', false, 3);
      }
      ...
      if (existingRecipeStepError) {
        throw errorGen(`*recipeSteps-create* Error getting existing recipeStep for recipe ID: ${recipeID} and step ID: ${stepID} while creating recipeStep ${existingRecipeStepError.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      if (existingRecipeStep.length) {
        throw errorGen(`*recipeSteps-create* RecipeStep with recipe ID: ${recipeID} and step ID: ${stepID} already exists, cannot duplicate recipeStep`, 515, 'cannotComplete', false, 3);
      }
      ...
      if (deletedRecipeStepError) {
        throw errorGen(`*recipeSteps-create* Error getting deleted recipeStep for recipe ID: ${recipeID} and step ID: ${stepID} while creating recipeStep ${deletedRecipeStepError.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      if (deletedRecipeStep.length) {
        ...
        if (undeleteError) {
          throw errorGen(`*recipeSteps-create* Error undeleting recipeStep: ${undeleteError.message}`, 513, 'failSupabaseUpdate', true, 3);
        }
      ...
      if (existingRecipeStepsError) {
        throw errorGen(`*recipeSteps-create* Error getting existing recipeSteps for recipe ID: ${recipeID} while creating recipeStep ${existingRecipeStepsError.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      //validate that provided sequence is positive integer
      if (sequence < 1) {
        throw errorGen(`*recipeSteps-create* Provided sequence: ${sequence} is less than 1, cannot create recipeStep`, 510, 'dataValidationErr', false, 3);
      }
      ...
      if (error) {
        throw errorGen(`*recipeSteps-create* Error creating recipeStep: ${error.message}`, 512, 'failSupabaseInsert', true, 3);
      }
      ...
      throw errorGen(err.message || '*recipeSteps-create* Unhandled Error', err.code || 520, err.name || 'unhandledError_recipeSteps-create', err.isOperational || false, err.severity || 2);
    }
  }
  ...
  async function publish(recipeID, recipeStepID, userID, authorization) {
    try {
      ...
      if (recipeUpdateError) {
        ...
        if (rollbackError) {
          throw errorGen(`*recipeSteps-publish* Error rolling back recipeStep: ${rollbackError.message}`, 514, 'failSupabaseDelete', true, 3);
        }
        throw errorGen(`*recipeSteps-publish* Error updating recipe status: ${recipeUpdateError.message}. Rolled back`, 515, 'cannotComplete', false, 3);
      }
      ...
      throw errorGen(err.message || '*recipeSteps-publish* Unhandled Error', err.code || 520, err.name || 'unhandledError_recipeSteps-publish', err.isOperational || false, err.severity || 2);
    }
  }
  ...
  async function update(options) {
    ...
    try {
      ...
      if (validationError) {
        throw errorGen(`*recipeSteps-update* Error validating recipeStep ID: ${recipeStepID} while updating recipeStep ${validationError.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      if (!recipeStep.length) {
        throw errorGen(`*recipeSteps-update* Provided recipeStep ID: ${recipeStepID} does not exist, cannot update recipeStep`, 515, 'cannotComplete', false, 3);
      }
      ...
      if (sequence) {
        ...
        if (sequence === recipeStep[0].sequence && !photoURL) {
          throw errorGen(`*recipeSteps-update* Provided sequence: ${sequence} is the same as existing sequence, no update needed`, 510, 'dataValidationErr', false, 3);
        }
        //validate that provided sequence is positive integer
        if (sequence < 1) {
          throw errorGen(`*recipeSteps-update* Provided sequence: ${sequence} is less than 1, cannot update recipeStep`, 510, 'dataValidationErr', false, 3);
        }
        ...
        if (existingRecipeStepsError) {
          throw errorGen(`*recipeSteps-update* Error getting existing recipeSteps for recipe ID: ${recipeStep[0].recipeID} while updating recipeStep ${existingRecipeStepsError.message}`, 511, 'failSupabaseSelect', true, 3);
        }
      }
      const updateFields = {};
      if (sequence) {
      ...
      throw errorGen(err.message || '*recipeSteps-update* Unhandled Error', err.code || 520, err.name || 'unhandledError_recipeSteps-update', err.isOperational || false, err.severity || 2);
    }
  }
  ...
  async function deleteStep(options) {
    ...
    try {
      ...
      if (validationError) {
        throw errorGen(`*recipeSteps-deleteStep* Error validating recipeStep ID: ${recipeStepID} while deleting recipeStep ${validationError.message}`, 511, 'failSupabaseSelect', true, 3);
      }
      if (!recipeStep.length) {
        throw errorGen(`*recipeSteps-deleteStep* Provided recipeStep ID: ${recipeStepID} does not exist, cannot delete recipeStep`, 515, 'cannotComplete', false, 3);
      }
      ...
      if (recipeStep[0].photoURL) {
        try {
          ...
          throw errorGen(err.message || `*recipeSteps-deleteStep* Error deleting photo for recipeStep ${recipeStepID}: ${err.message}`, err.code || 520, err.name || 'unhandledError_recipeSteps-deleteStep', err.isOperational || false, err.severity || 2);
        }
      }
      ...
      if (existingRecipeStepsError) {
        throw errorGen(`*recipeSteps-deleteStep* Error getting existing recipeSteps for recipe ID: ${recipeStep[0].recipeID} while deleting recipeStep ${existingRecipeStepsError.message}`, 511, 'failSupabaseSelect', true, 3);
      }

      //delete recipeStep
      const { error: deleteError } = await db.from('recipeSteps').update({ deleted: true }).eq('recipeStepID', recipeStepID);
      if (deleteError) {
        throw errorGen(`*recipeSteps-deleteStep* Error deleting recipeStep ${recipeStepID}: ${deleteError.message}`, 514, 'failSupabaseDelete', true, 3);
      }
      ...
      if (!version) {
        throw errorGen(`*recipeSteps-deleteStep* Error getting recipe version for recipeID:${recipeStep[0].recipeID} after deleting recipeStep`, 515, 'cannotComplete', false, 3);
      } else {
      ...
      if (deleteStepError) {
        throw errorGen(`*recipeSteps-deleteStep* Error deleting associated step ${recipeStep[0].stepID}: ${deleteStepError.message}`, 514, 'failSupabaseDelete', true, 3);
      }
      //add a 'deleted' log entry
      ...
      if (existingRecipeSteps.length === 1) {
        ...
        if (recipeUpdateError) {
          throw errorGen(`*recipeSteps-deleteStep* Error updating recipe status: ${recipeUpdateError.message}`, 514, 'failSupabaseDelete', true, 3);
        }
      ...
      throw errorGen(err.message || '*recipeSteps-deleteStep* Unhandled Error', err.code || 520, err.name || 'unhandledError_recipeSteps-deleteStep', err.isOperational || false, err.severity || 2);
    }
  }

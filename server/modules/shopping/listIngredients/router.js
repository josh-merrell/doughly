...
} = require('../../../schemas/shopping-types');
...
router.get('/byListDisplay/:shoppingListID', routeValidator(getIngredientsByShoppingListSchema_params, 'params'), errorCatcher(h.getDisplayIngredientsByShoppingList));

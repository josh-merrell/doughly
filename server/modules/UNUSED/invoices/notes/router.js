...
router.post('/:invoiceID', generateID, routeValidator(newInvoiceNoteSchema_body, 'body'), routeValidator(newInvoiceNoteSchema_params, 'params'), errorCatcher(h.createInvoiceNote));

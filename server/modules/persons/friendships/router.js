...
const { getFriendshipsSchema_query, getFriendshipSchema_params, newFriendshipSchema_body, friendshipUpdateSchema_body, friendshipUpdateSchema_params, friendshipDeleteSchema_params } = require('../../../schemas/friendship-types');
...
router.patch('/:friendshipID', routeValidator(friendshipUpdateSchema_body, 'body'), routeValidator(friendshipUpdateSchema_params, 'params'), errorCatcher(h.updateFriendship));

...
router.patch(
  '/:recipeComponentID',
  routeValidator(RecipeComponentUpdateSchema_body, 'body'),
  routeValidator(RecipeComponentUpdateSchema_params, 'params'),
  errorCatcher(h.updateRecipeComponent),
);
...
router.post('/', routeValidator(newRecipeComponentSchema_body, 'body'), errorCatcher(h.createRecipeComponent));

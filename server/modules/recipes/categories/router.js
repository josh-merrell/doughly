...
router.post('/', routeValidator(newRecipeCategorySchema_body, 'body'), errorCatcher(h.createRecipeCategory));
router.patch(
  '/:recipeCategoryID',
  routeValidator(RecipeCategoryUpdateSchema_body, 'body'),
  routeValidator(RecipeCategoryUpdateSchema_params, 'params'),
  errorCatcher(h.updateRecipeCategory),
);

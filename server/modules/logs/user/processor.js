...
module.exports = ({ db }) => {
  ...
  async function create(options) {
    ...
    try {
      ...
      throw errorGen(err.message || '*userLogs-create* Unhandled Error', err.code || 520, err.name || 'unhandledError_userLogs-create', err.isOperational || false, err.severity || 2);
    }
  }

...
const addShoppingListIngredient = createAction(
  '[ShoppingListIngredients] Add',
  props<{
...
const batchAddShoppingListIngredients = createAction(
  '[ShoppingListIngredients] Batch Add',
  props<{
    shoppingListID: number;
    ingredients: {
      ingredientID: number;
...
const updateShoppingListIngredient = createAction(
  '[ShoppingListIngredients] Update',
  props<{

...
export class StringsService {
  public readonly onboardingStrings = {
    ...
    socialPageOverview: `Here you can find and connect with friends. You can see their recipes and they'll see yours. Keep your cherished recipes in one place for family to refer to any time they're feeling hungry or nostalgic!`,
    ...
    recipeCreateImage: `Choose a photo or screenshot of a recipe you'd like to add, handwritten is fine! Add a display image if you have one. We'll use AI to extract the details, map them to your existing kitchen items, and create any new ones you need. Give it a go when you're ready!`,

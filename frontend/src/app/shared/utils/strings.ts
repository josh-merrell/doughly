...
export class StringsService {
  ...
  public readonly productStrings = {
    ...
    subscribeOverviewBenefit1of2: `Subscribers to Doughly Premium import recipes`,
    subscribeOverviewBenefitmultiplier: ' 5.7 ',
    subscribeOverviewBenefit2of2: `times faster with AI!`,
    subscriptionNotNeeded: `Subscription to Premium not needed to use Doughly`,
    subscribeChartBenefit: `Subscribers to Premium get the most from thier recipes!`,
    subscribeYourPremium: `Your subscription to Premium is serving you well. Thank you for your support!`,
    subscribeYourLifetime: `You have Lifetime access for unlimited recipes! Add a subscription to Premium for monthly AI Import tokens and guaranteed data backups.`,
    ...
    freeTierRecipeSelection: `Any Recipe not selected will be unavailable and archived upon canceling your subscription to Premium.`,
    freeTierSubscriptionSelection: `Any Recipe Subscriptions not selected will be unavailable and archived upon canceling your subscription to Premium.`,
